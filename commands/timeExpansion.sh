...
if [ $1 = "Live" ]; then
	...
	(sox -t wav -e signed-integer -b16 -r 192000 -c 2 $1 -t wav -e signed-integer -b16 -r 192000 -c 2 /dev/stdout sinc 10k speed 0.1 gain -n -5 |  aplay -D hw:sndrpiwsp -) &> /dev/null
fi
